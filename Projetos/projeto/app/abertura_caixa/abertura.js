...
function RegistrarMovimentacao() {
    ...
    if (document.getElementById('input-data').value == '' || document.getElementById('input-nomefuncionario').value == '' || document.getElementById('input-descricao').value == '' || document.getElementById('input-quantia').value == '' || document.getElementById('status-caixa').value == '') {
